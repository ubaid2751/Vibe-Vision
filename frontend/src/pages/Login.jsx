    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a1f] to-[#1a1a2f] flex items-center justify-center p-5 relative overflow-hidden">
      ...
      >
        <div className="mb-10 text-center">
          ...
          <p className="mt-2 text-gray-400">Sign in to your emotion intelligence dashboard</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <motion.button
            ...
            disabled={!!emailError || !!passwordError || password.length < 8}
          >
            <span className="relative z-10">Sign In</span>
            <motion.div
              className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0"
              whileHover={{ opacity: !emailError && !passwordError && password.length >= 8 ? 0.1 : 0 }}
            />
          </motion.button>
        </form>
